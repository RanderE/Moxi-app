...
class Jpgoods extends Component{
    componentDidMount(){
        axios.get('http://api.moximoxi.net/api/Home/GetHomeMenuNavigation?ProClassId=247&pageIndex='+this.state.num).then(res=>{
